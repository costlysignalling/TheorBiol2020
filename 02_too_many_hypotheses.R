...
l <- loess(d$cat_love ~ ext, span=1.5)
...
polygon(c(newx,rev(newx)),c(newy$fit+newy$se.fit*1.96,rev(newy$fit-newy$se.fit*1.96)),border=NA,col="#00000030")
...
ext3<-seq(-2,2,0.01)
cat.love3<-ext3*(-0.8)+(ext3^2)*0.4+(ext3^3)*(-0.5)+rnorm(length(ext3),0,0.2)
